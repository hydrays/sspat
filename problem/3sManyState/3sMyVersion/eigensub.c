...
void elemhess(int job,double mat[],int n,int low,int hi, double vr[],
              double vi[])
{
    int *array=NULL,i,j,m;
    double x,y;

    if (hi - low > 1) array = (int*) malloc(hi*sizeof(int));
