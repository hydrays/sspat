...
!!$  end subroutine output_to_file
  ...
  subroutine output_to_file2(unit, time)
    ...
    write(unit, '(f10.2, f10.2, f10.2)'), time, cs, exlevel
  ...
  subroutine update_signal(t)
    ...
    ! update scheme 3
    !cs = max(0.0, (1.0+cos(5.0*t))/2.0)
  end subroutine update_signal
