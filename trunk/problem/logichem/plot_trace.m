...
% ===========
% script for 1 feedback, woundhealing
% ===========
load paperresult_tr_1f_wondhealing
tr = paperresult_tr_1f_wondhealing;
...
ylim([0, 600])
%set(get(h,'axis'),'FontSize',24)
print('-depsc','fig_logi_1f_woundhealing.eps')
figure
...
print('-depsc','fig_logi_1f_woundhealing_supp.eps')
